...
public class enemyDirector : MonoBehaviour
{
    ...
    private void Update()
    {
        Vector3 targetPos = GameObject.Find("player").transform.position;//playerを見つける
    ...
    void FixedUpdate()
    {
        Vector3 targetPos = GameObject.Find("player").transform.position; //プレイヤーの位置を取得、targetPosに代入
        Vector3 startPos = GameObject.Find("enemy").transform.position;//エネミーの位置を取得、startPosに代入
